...
function frequencyCheck(stream,freq)
{	
	...
	var intervalId=setInterval(function(){
		...
		if(i<elements.length)
			...
			streamDiv.style.backgroundColor="#0AF71E";
		...
		frequentElements.forEach(function(value, key) {
			count=0;
			finalDisp.innerHTML=finalDisp.innerHTML + "<br/><span><div class='loader-block' style='text-align:middle;'>"+key+"</div>";
			...
			finalDisp.innerHTML=finalDisp.innerHTML + "<div class='loader-block1' style='text-align:middle;'>"+count.toString()+"</div><br/></span>";
...
function algorithm(element,k)
{
	...
	//Associative array full and new entry
	else	{
