...
function frequentOperation()
{
	...
	document.getElementById('freq-div').style.display='block';
	document.getElementById('freq_word_label').style.display='block';
	document.getElementById('freq-inp').style.display='block';	
}
          ...
          <td width="30%">
            ...
            <div class="radios">
				Majority Check<input type="radio" name="option" value="majority"
					onchange="document.getElementById('myForm').action = 'majority.jsp'; 
				...
				Frequency Check<input type="radio" name="option" value="anim" checked="checked" 
					onchange="document.getElementById('myForm').action = 'animation.jsp';
					...
					document.getElementById('freq-div').style.display='none';
					document.getElementById('freq-div').disabled=true">
				<!-- Frequent Word Check<input type="radio" name="option" value="freq" checked="checked" 
					onchange="frequentOperation();
					document.getElementById('k-div').style.display='block';
					document.getElementById('k-div').disabled=false;
					document.getElementById('min_freq').style.display='block';
					document.getElementById('min_freq').disabled=false;"/>           -->    
