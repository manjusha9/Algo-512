...
<script src="js/angular2.js"></script> 
    <script src="js/majority_check.js"></script>
    <style type="text/css">
    body {
  text-align: center;
}
...
<div>
	...
	<div class="button-class"><div id="new-button"></div></div><button type="submit" class="button-block" id="mybutton" onclick="majorityCheck('<%=stream%>','<%=freq%>');">Check Majority</button>        
	</div>
	</div>
</div>
